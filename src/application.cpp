...
void Application::init() {
	...
	_instance->use(_physicalDevice);
	_instance->create_cube_accessors();
	_instance->set_msaa_samples(graphics::get_max_usable_sample_count(_physicalDevice));
	_instance->create_device();
	_instance->create_swapchain();
	_instance->create_image_views();
	_instance->create_pipeline("shaders/vertex.glsl", "shaders/frag.glsl");
	_instance->create_command_pool();
	_instance->create_short_lived_command_pool();
	_instance->create_color_resources();
	_instance->create_depth_img();
	_instance->create_framebuffers();
	_instance->create_descriptor_pool();
	_instance->init_cube_accessors();
